...
BANK_HOLIDAYS = {
    ...
    datetime.date(2018, 1, 1): ('NewYearsDay',),
    ...
    datetime.date(2019, 1, 1): ('NewYearsDay',),
    ...
    datetime.date(2019, 1, 1): ('NewYearsDay',),
    datetime.date(2019, 4, 10): ('GoodFriday',),
    datetime.date(2019, 4, 13): ('EasterMonday', 'HolidayMondays'),
    datetime.date(2019, 5, 4): ('MayDay', 'HolidayMondays'),
    datetime.date(2019, 5, 25): ('SpringBank', 'HolidayMondays'),
    datetime.date(2019, 8, 31): ('LateSummerBankHolidayNotScotland', 'HolidayMondays'),
    datetime.date(2019, 12, 25): ('ChristmasDay', 'Christmas'),
    datetime.date(2019, 12, 26): ('BoxingDay', 'Christmas'),
